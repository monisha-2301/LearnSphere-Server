...
exports.enrollCourse = async (req, res) => {
    try {
        ...
        userDetails.courseProgress.push(courseProgress._id);
        ...
        console.log('Error in course enrollment');
        console.error(error);
...
exports.createCourse = async (req, res) => {
    try {
        ...
        const newCourse = await Course.create({
            courseName, courseDescription, instructor: instructorId, whatYouWillLearn, category: categoryDetails._id,
